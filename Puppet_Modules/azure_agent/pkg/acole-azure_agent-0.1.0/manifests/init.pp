...
class azure_agent (
  ...
  if is_string($resourcedisk_swapsizemb) {
    ...
    fail('azure_agent::resourcedisk_swapsizemb must be a string. ')
  } 

  if is_string($os_rootdevicescsitimeout) {
    ...
    fail('azure_agent::os_rootdevicescsitimeout must be a string. ')
  } 
